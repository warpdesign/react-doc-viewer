...
var Contents = function (_a) {
    ...
    var textTertiary = (0, react_1.useContext)(styled_components_1.ThemeContext).textTertiary;
    if (!documents.length) {
        ...
        return (react_1.default.createElement(LoadingTimout_1.LoadingTimeout, null,
            react_1.default.createElement(LoadingContainer, { id: "loading-renderer", "data-testid": "loading-renderer" },
                react_1.default.createElement(LoadingIconContainer, null,
                    react_1.default.createElement(icons_1.LoadingIcon, { color: textTertiary, size: 40 })))));
    }
    else {
        if (CurrentRenderer) {
