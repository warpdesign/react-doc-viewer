...
var PDFSinglePage = function (_a) {
    ...
    var _b = (0, react_1.useContext)(state_1.PDFContext).state, paginated = _b.paginated, zoomLevel = _b.zoomLevel, numPages = _b.numPages, currentPage = _b.currentPage;
    var mainState = (0, react_1.useContext)(DocViewerProvider_1.DocViewerContext).state;
