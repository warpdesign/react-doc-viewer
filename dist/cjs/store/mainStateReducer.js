...
var mainStateReducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case actions_1.UPDATE_CURRENT_DOCUMENT: {
            ...
            return __assign(__assign({}, state), { currentDocument: document_1, currentFileNo: state.documents.findIndex(function (doc) { return doc.uri === document_1.uri; }), documentLoading: true });
        }
