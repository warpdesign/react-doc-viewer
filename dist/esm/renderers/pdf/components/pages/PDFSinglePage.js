...
var PDFSinglePage = function (_a) {
    ...
    var _b = useContext(PDFContext).state, paginated = _b.paginated, zoomLevel = _b.zoomLevel, numPages = _b.numPages, currentPage = _b.currentPage;
    var mainState = useContext(DocViewerContext).state;
